...
class AdministradorScreenTest extends StatefulWidget {
  ...
  @override
  _AdministradorScreenTestState createState() =>
      _AdministradorScreenTestState();
}
...
class _AdministradorScreenTestState extends State<AdministradorScreenTest> {
  ...
  Future<void> _loadAdmins() async {
    ...
    try {
      final querySnapshot =
          await widget.firestore.collection('administradorSPC').get();
      _admins =
...
void main() {
  group(
    'HASHIRA AI - Pruebas de Widget: Módulo Gestión de Administradores',
    () {
